...
full_vip = ({
    ...
    'irs_type': {'value': 0, 'comment': '0- output, options, and stop, 1 - ARM AERI data, 2 - dmv2cdf AERI data (C1_rnc.cdf and _sum.cdf), 3 - dmv2ncdf (C1.RNC.cdf and .SUM.cdf), 5- ASSIST, 6- REFIR-PAD(0.400), 7- REFIR-PAD(0.3892), -1 - MWR data is to be used as MASTER dataset (no IRS data being read in)', 'default': True},
    ...
    'ext_sfc_temp_type': {'value': 0, 'comment': 'External surface temperature met data type: 0-none, 1-external met data', 'default': True},
    'ext_sfc_temp_fieldname': {'value': 'temp_mean', 'comment': 'Name of surface temperature met field', 'default': True},
    'ext_sfc_temp_units': {'value': 1, 'comment': 'Units of surface temperature met field: 1-degC, 2-degK', 'default': True},
    ...
    'add_tropoe_co2_input_flag':    {'value': 0, 'comment': 'Flag to add previous good TROPoe co2 retrieval as input to current retrieval (1-yes, 0-no)', 'default': True},
    ...
    'add_tropoe_co2_noise_adder':   {'value': [1.0,  1], 'comment': '2-element comma delimited list with the noise to add to the co2 (BL and free trop values) (must be >= 1)', 'default': False},
    'add_tropoe_co2_delay_value':   {'value': [4.0, 10], 'comment': '2-element comma delimited list with the time delay values (BL and free trop values) (must be >= 1)', 'default': False},
